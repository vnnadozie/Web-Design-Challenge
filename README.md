...
## Observations :
From the weather data for 500+ cities collected, I concluded that max temperature is higher near the equator.
There is no obvious correlation between cloudiness and latitude.
The humidity percentage has only weak correlation with latitude.
There is no obvious correlation between wind speed and latitude. The wind speed generally is from 0 mph to 15 mph.
